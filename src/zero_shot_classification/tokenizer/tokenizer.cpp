...
Tokenizer::Tokenizer() : Tokenizer("tokenizer/bpe_simple_vocab_16e6.txt") {}

Tokenizer::Tokenizer(const std::string& bpe_vocab_path){

    std::string content = read_text_file(bpe_vocab_path);
